...
export default class Loading extends React.Component<{
  ...
  public render() {
    return (
      <div className={`${styles.loading} ${this.props.visible ? '' : styles.hidden}`}>
        <svg xmlns='http://www.w3.org/2000/svg' className={styles.spinner} preserveAspectRatio='xMidYMid' viewBox='0 0 100 100'>
